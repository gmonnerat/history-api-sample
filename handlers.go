...
func renderHomeContainer() echo.HandlerFunc {
	return func(c echo.Context) error {
		params := map[string]interface{}{"title": "Home"}
		str, _ := executeContainerTemplate("templates/home.tmpl", params)
		c.HTML(http.StatusOK, str)
		return nil
	}
}

func renderNewTaskContainer() echo.HandlerFunc {
	return func(c echo.Context) error {
		params := map[string]interface{}{"title": "New Task"}
		str, _ := executeContainerTemplate("templates/new_task.tmpl", params)
		c.HTML(http.StatusOK, str)
		return nil
	}
}

func createNewTask() echo.HandlerFunc {
	return func(c echo.Context) error {
...
func newTaskPage() echo.HandlerFunc {
	return func(c echo.Context) error {
		params := map[string]interface{}{"title": "New Task"}
		str, _ := executeTemplate("templates/new_task.tmpl", params)
		c.HTML(http.StatusOK, str)
		return nil
	}
}
